...
Route::middleware('auth')->group(function () {
    ...
    // イベント一覧
    Route::get('/events', [EventController::class, 'eventIndex']);
    // 過去のイベント一覧
    Route::get('/past-events', [EventController::class, 'PastEventIndex']);
    ...
    // 予約
    Route::get('/event/reservation/{event_id}', [ReservationController::class, 'reserveIndex']);
    ...
    // お問合せ詳細
    Route::get('/contact/{contact_id}', [ContactController::class, 'contactDelete']);
    // お問合せ削除
